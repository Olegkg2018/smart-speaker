...
class Settings(BaseSettings):
    ...
    expert_model: str = ""
    # На репликах-продолжениях (сразу после ответа колонки) вызов какого-нибудь
    # инструмента обязателен (tool_choice="required"): либо конкретный, если он
    # подходит, либо ask_expert. Выключите, если пауза на слух мешает.
    expert_force_on_followup: bool = True
